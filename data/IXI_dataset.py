    ...
    def __getitem__(self, idx):
        ...
        if self.task == 'rec':
            ...
            if self.model=='ref-rec' and self.undersample == 'learned' and self.diffusion in ['Loupe']:
                mask_path1 = '/home/xinming/JUF_MRI/dataset/IXI/'+self.model_G+'_mask/'
                ...
                mask_path1 = '/home/xinming/JUF_MRI/IXI_mask/IXI_hard_mask/'
                mask_path = mask_path1 + 'x' + str(self.scale) + '_mask_hard_IXI.png'

            elif self.model=='ref-rec'and self.undersample != 'learned' :
                mask_path1='/home/xinming/JUF_MRI/IXI_mask/IXI_fixed_mask/'
